...
public class GiantZombie_Char_Instantiate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pref.gameObject.GetComponent<GiantZombie_CharacterCustomize>().trousersVisible = trousersVisible;
		pref.gameObject.GetComponent<GiantZombie_CharacterCustomize>().sneakerLeftVisible = sneakerLeftVisible;
		pref.gameObject.GetComponent<GiantZombie_CharacterCustomize>().sneakerRightVisible = sneakerRightVisible;
		pref.gameObject.GetComponent<GiantZombie_CharacterCustomize>().charCustomize(bodyTyp, trousersTyp, tanktopTyp, tshirtTyp, headTyp, trousersVisible, sneakersTyp, legsTyp, eyesTyp);
