...
public class BigZombieJiggleBelly : MonoBehaviour
...

{
    ...
    public Vector3 upAxis = new Vector3(-1, 0, 0);
    public float targetDistance = 2.0f;

    // Dynamics settings
    public float bStiffness = 0.01f;
    public float bMass = 2f;
    public float bDamping = 0.1f;
    ...
    void LateUpdate()
    {
        ...
        Vector3 upVector = targetBone.TransformDirection(upAxis);
        ...
        if (debugMode)
        {
            ...
            //print("dynPos=" + dynamicPos + "  targetPos=" + targetPos);
        }
        // ==================================================
    }
}